...
class ArmMsgMotionCtrl_2():
    ...
    Bit Descriptions:
        ...
        Byte 1 move_mode: uint8, movement mode selection.
            ...
            0x06: MOVE MIT ---- Based on version V1.8-8 and later
    ...
    def __init__(self, 
                 ...
                 move_mode: Literal[0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06] = 0x01, 
        ...
        if move_mode not in [0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06]:
            raise ValueError(f"'move_mode' Value {move_mode} out of range [0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06]")
